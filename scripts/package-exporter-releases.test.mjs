...
test('Multiblock Madness exporter releases remain isolated across independent versions', () => {
  ...
  assert.deepEqual(
    ...
    },
    {
      ...
      version: '1.2.0-beta.109',
      source: 'recipe-export-mod-1.12.2/build/libs/recipe-export-mod-1.12.2-1.2.0-beta.109.jar',
      filename: 'recipe-tree-exporter-forge-1.12.2-1.2.0-beta.109.jar',
