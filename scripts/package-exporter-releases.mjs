...
export const EXPORTER_RELEASE_DEFINITIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    version: '1.2.0-beta.115',
    source: 'recipe-export-mod-1.12.2/build/libs/recipe-export-mod-1.12.2-1.2.0-beta.115.jar',
    filename: 'recipe-tree-exporter-forge-1.12.2-1.2.0-beta.115.jar',
